...
app.use('/images', express.static(path.join(__dirname, 'Public/Images'))); // para que funcione en render y pueda encontrar la carpeta correcta ya que hay problemas con el case sensitive
